...
void Vehicle::simulate()
{
    ...
    // _threads.emplace_back(t);//not working because thread obj does not have a copy constructor, so simply push_back/emplace_back not working.
    // _threads.push_back(std::move(t));
    // _threads.emplace_back(std::move(t));
    _threads.emplace_back(std::thread(&Vehicle::drive,this)); // or simply pass the obj rvalue itself 
    std::cout<< " out of simulate " << std::endl;
}
