...
class Vehicle : public TrafficObject, public std::enable_shared_from_this<Vehicle> // enable pass "this" as a pointer  
{
public:
    ...
    // miscellaneous return a instance of obj itself when the instance itself is a shared pointer  
